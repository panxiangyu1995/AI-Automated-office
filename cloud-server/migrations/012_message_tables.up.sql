...
-- Index for audit cleanup job
CREATE INDEX idx_audit_cleanup ON message_audit_logs(expires_at, id) WHERE expires_at < EXTRACT(EPOCH FROM NOW())::BIGINT + 180 * 24 * 60 * 60 * 1000;
