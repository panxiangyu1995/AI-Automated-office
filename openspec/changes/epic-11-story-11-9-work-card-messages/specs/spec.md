...
### Requirement: Story 11.9 - Work Card Messages
The system SHALL implement the full acceptance scope for Story 11.9 while staying aligned with FR(FR607, FR608, FR609, FR610), NFR(NFR1), ARCH(ADR-037), and UX(UX-01, UX-04).

#### Scenario-1: Acceptance item 1
- **GIVEN** dependencies are complete and communication/connector governance is active
- **WHEN** Render structured work-card messages in chat
- **THEN** runtime state, routing outcome, and audit traces SHALL remain consistent and permission-safe

#### Scenario-2: Acceptance item 2
- **GIVEN** dependencies are complete and communication/connector governance is active
- **WHEN** Support card actions with result feedback
- **THEN** runtime state, routing outcome, and audit traces SHALL remain consistent and permission-safe

#### Scenario-3: Acceptance item 3
- **GIVEN** dependencies are complete and communication/connector governance is active
- **WHEN** Allow Agent-generated work-card delivery
- **THEN** runtime state, routing outcome, and audit traces SHALL remain consistent and permission-safe
