...
### Requirement: Story 4.11 - Checkpoint Management
The system SHALL implement the full acceptance scope for Story 4.11 while staying aligned with FR(FR17-19, FR17-20, FR17-21, FR17-22, FR17-23), NFR(NFR17), ARCH(ADR-037), and UX(UX-01, UX-04).

#### Scenario-1: Acceptance item 1
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** List checkpoints with summary metadata
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-2: Acceptance item 2
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Allow deletion and retention marking
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-3: Acceptance item 3
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Support automatic cleanup policy display and control
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable
