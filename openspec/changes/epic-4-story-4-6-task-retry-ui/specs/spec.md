...
### Requirement: Story 4.6 - Task Retry Ui
The system SHALL implement the full acceptance scope for Story 4.6 while staying aligned with FR(FR16), NFR(NFR22), ARCH(ADR-037), and UX(UX-01, UX-04).

#### Scenario-1: Acceptance item 1
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Show retry status for failed tasks
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-2: Acceptance item 2
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Render retry count and backoff behavior in execution history
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-3: Acceptance item 3
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Provide clear terminal failure explanation to users
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable
