...
### Requirement: Story 7.6 - Loop Detection
The system SHALL implement the full acceptance scope for Story 7.6 while staying aligned with FR(FR420), NFR(NFR8-5, NFR23-2), ARCH(ADR-037), and UX(UX-01, UX-04).

#### Scenario-1: Acceptance item 1
- **GIVEN** dependencies are complete and runtime guardrails are active
- **WHEN** Detect repeated runtime states and tool loops
- **THEN** planner/executor state, outputs, and traces SHALL remain consistent and auditable

#### Scenario-2: Acceptance item 2
- **GIVEN** dependencies are complete and runtime guardrails are active
- **WHEN** Interrupt execution on loop threshold
- **THEN** planner/executor state, outputs, and traces SHALL remain consistent and auditable

#### Scenario-3: Acceptance item 3
- **GIVEN** dependencies are complete and runtime guardrails are active
- **WHEN** Show loop reason and recovery path
- **THEN** planner/executor state, outputs, and traces SHALL remain consistent and auditable
