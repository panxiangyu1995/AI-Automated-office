...
### Requirement: Story 4.8 - Checkpoint Restore
The system SHALL implement the full acceptance scope for Story 4.8 while staying aligned with FR(FR17-6, FR17-7, FR17-8, FR17-9), NFR(NFR23), ARCH(ADR-037), and UX(UX-01, UX-04).

#### Scenario-1: Acceptance item 1
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Add checkpoint restore actions in the session UI
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-2: Acceptance item 2
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Support conversation-only and conversation-plus-content restore modes
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-3: Acceptance item 3
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Record restore decisions into runtime history
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable
