...
### Requirement: Story 4.4 - Model Provider Settings
The system SHALL implement the full acceptance scope for Story 4.4 while staying aligned with FR(FR18, FR19), NFR(NFR29), ARCH(ADR-037), and UX(UX-02, UX-04).

#### Scenario-1: Acceptance item 1
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Expose current provider and model configuration in settings
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-2: Acceptance item 2
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Support API key and relay mode selection
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-3: Acceptance item 3
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Allow connection test from the UI
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable
