...
### Requirement: Story 4.7 - Checkpoint Auto Create
The system SHALL implement the full acceptance scope for Story 4.7 while staying aligned with FR(FR17-1, FR17-2, FR17-4), NFR(NFR23), ARCH(ADR-037), and UX(UX-01, UX-04).

#### Scenario-1: Acceptance item 1
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Create checkpoints on message submission
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-2: Acceptance item 2
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Capture session metadata and related working state
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-3: Acceptance item 3
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Display checkpoint markers in the conversation stream
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable
