...
### Requirement: Story 4.1 - Agent Chat Ui
The system SHALL implement the full acceptance scope for Story 4.1 while staying aligned with FR(FR9), NFR(NFR3), ARCH(ADR-037), and UX(UX-01, UX-04).

#### Scenario-1: Acceptance item 1
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Integrate the common runtime session stream into the AI panel
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-2: Acceptance item 2
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Render user and assistant messages with streaming updates
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable

#### Scenario-3: Acceptance item 3
- **GIVEN** prerequisite dependencies are complete and the user has valid permission context
- **WHEN** Support markdown and code display in responses
- **THEN** runtime state, persisted records, and UI status stay consistent and auditable
