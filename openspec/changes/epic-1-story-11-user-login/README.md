...
实现用户认证入口功能，登录/注册/忘记密码请求统一调用 Go 云端认证接口，访问个人工作空间。支持"记住我"功能和密码找回请求受理。

## 铁律映射

### PRD 需求
- **FRs**: FR1（用户可以通过桌面应用登录系统）, FR27（用户可以使用账号密码登录系统）, FR28（管理员可以创建和编辑用户账号）
