...
### Requirement: Story 21.19 - Sub Agent Tool Binding
The system SHALL implement the full acceptance scope for Story 21.19 while staying aligned with FR(FR915, FR916, FR917, FR918, FR919), NFR(NFR16), ARCH(ADR-042, ADR-046), and UX(UX-02, UX-04).

#### Scenario-1: Acceptance item 1
- **GIVEN** dependencies are complete and operator has required configuration permissions
- **WHEN** Bind allowed MCP tools to a Sub-Agent
- **THEN** config state, runtime effect, and audit traces SHALL remain consistent

#### Scenario-2: Acceptance item 2
- **GIVEN** dependencies are complete and operator has required configuration permissions
- **WHEN** Bind allowed Skills and effective approve policy
- **THEN** config state, runtime effect, and audit traces SHALL remain consistent

#### Scenario-3: Acceptance item 3
- **GIVEN** dependencies are complete and operator has required configuration permissions
- **WHEN** Persist scoped capability selection
- **THEN** config state, runtime effect, and audit traces SHALL remain consistent
