...
### Requirement: Story 11.5 - Agent Group Participation
The system SHALL implement the full acceptance scope for Story 11.5 while staying aligned with FR(FR619, FR620, FR621, FR639, FR640, FR641, FR642, FR643, FR644, FR645, FR646, FR649), NFR(NFR16), ARCH(ADR-037), and UX(UX-01, UX-04).

#### Scenario-1: Acceptance item 1
- **GIVEN** dependencies are complete and communication/connector governance is active
- **WHEN** Allow Agent presence inside group chats under policy
- **THEN** runtime state, routing outcome, and audit traces SHALL remain consistent and permission-safe

#### Scenario-2: Acceptance item 2
- **GIVEN** dependencies are complete and communication/connector governance is active
- **WHEN** Display AI identity markers and speaking rules
- **THEN** runtime state, routing outcome, and audit traces SHALL remain consistent and permission-safe

#### Scenario-3: Acceptance item 3
- **GIVEN** dependencies are complete and communication/connector governance is active
- **WHEN** Support mention-driven and event-driven participation
- **THEN** runtime state, routing outcome, and audit traces SHALL remain consistent and permission-safe
