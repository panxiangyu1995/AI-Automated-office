...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tender::tender_create_template,
            tender::tender_get_template,
            tender::tender_list_templates,
            tender::tender_update_template,
            tender::tender_delete_template,
            tender::tender_create_document,
            tender::tender_get_document,
            tender::tender_list_documents,
            ...
            // Data governance commands (Epic 19 Story 19.5)
            security::security_create_classification,
            security::security_get_classification,
            security::security_list_classifications,
            security::security_update_classification,
            security::security_delete_classification,
            security::security_create_masking_rule,
            security::security_list_masking_rules,
            security::security_update_masking_rule,
            security::security_delete_masking_rule,
            security::security_apply_masking,
            security::security_create_retention_policy,
            security::security_list_retention_policies,
            security::security_record_sensitive_access,
            security::security_get_sensitive_access,
            security::security_get_governance_stats,
