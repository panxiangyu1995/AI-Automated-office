...
pub fn register_sessions_tools(
    ...
    let descriptor = ToolDescriptor {
        ...
        permissions: Some(vec!["sessions:read".to_string()]),
        dependencies: None,
    ...
    let descriptor = ToolDescriptor {
        ...
        permissions: Some(vec!["sessions:write".to_string()]),
        dependencies: None,
        context_requirements: None,
        metadata: ToolMetadata {
            author: Some("AI-Automated-Office".to_string()),
    ...
    let descriptor = ToolDescriptor {
        ...
        permissions: Some(vec!["sessions:admin".to_string()]),
        dependencies: None,
        context_requirements: None,
        metadata: ToolMetadata {
            author: Some("AI-Automated-Office".to_string()),
    ...
    let descriptor = ToolDescriptor {
        ...
        capabilities: ToolCapabilities {
            ...
            has_side_effects: false,
            supports_retry: false,
            estimated_duration: Some(std::time::Duration::from_millis(20)),
        },
        permissions: Some(vec!["sessions:read".to_string()]),
        dependencies: None,
        context_requirements: None,
