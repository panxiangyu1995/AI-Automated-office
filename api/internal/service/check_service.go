...
func (s *InventoryCheckService) Complete(checkID string) (*model.InventoryCheck, *apperrors.AppError) {
	...
	if dbErr != nil { return nil, apperrors.ErrInternal.WithDetail("查询盘点单失败") }
	if check == nil { return nil, apperrors.ErrNotFound.WithDetail("盘点单不存在") }
...
func (s *InventoryCheckService) List(eid string, p, ps int) ([]model.InventoryCheck, int64, *apperrors.AppError) {
	...
	if dbErr != nil { return nil, 0, apperrors.ErrInternal.WithDetail("查询盘点列表失败: "+dbErr.Error()) }
