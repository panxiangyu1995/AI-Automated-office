...
const mockHistory: ToolHistoryEntry[] = [
  ...
  },
  {
    ...
    sessionId: 'sess-002',
    userId: 'user-002',
    input: { query: 'SELECT * FROM users WHERE id = ?', params: ['abc'] },
    error: 'Database connection failed',
    retryCount: 2,
    isRetained: true,
    retentionDays: 30,
    policyTrace: ['validate', 'permission_check', 'execute', 'error', 'retry_1', 'retry_2', 'terminal'],
    permissionCheck: 'passed',
  },
  {
    id: 'h4',
    ...
    sessionId: 'sess-001',
    userId: 'user-001',
    input: { task: 'analyze_data', params: {} },
    output: { result: 'analysis_complete' },
    retryCount: 0,
    isRetained: true,
    retentionDays: 90,
    policyTrace: ['validate', 'permission_check', 'sensitive_check', 'confirm', 'execute'],
    permissionCheck: 'passed',
  },
  {
    id: 'h5',
  ...
  },
  {
    ...
    sessionId: 'sess-001',
    userId: 'user-001',
    input: { service: 'weather', action: 'get_forecast' },
    retryCount: 1,
    isRetained: true,
    retentionDays: 30,
    permissionCheck: 'passed',
...
const mockStats: ToolHistoryStats = {
  ...
  retryCount: 89,
  topTools: [
    { name: 'fs_read_file', count: 342 },
    { name: 'http_request', count: 256 },
    { name: 'db_query', count: 198 },
    { name: 'agent_execute', count: 145 },
    { name: 'system_command', count: 98 },
  ],
  dailyTrend: [
