/**
 * Session Runtime - Core Exports
 * Session lifecycle, store, API, state machine, context, memory, knowledge, trace, audit, failure, metrics, form writeback, field auth, detail writeback
 */
